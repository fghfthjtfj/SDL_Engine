...
public:
	...
	// Õ‡˜ËÌ‡ÂÚ Ë Á‡‚Â¯‡ÂÚ SDL_GPURenderPass
	// Starts and end SDL_GPURenderPass
	void RenderPassStandardBody(SDL_GPUCommandBuffer* cb, RenderPassStep* render_pass, BufferManager* bm, uint32_t additional_offset); // ƒŒ¡¿¬»“‹ ¿Õ¿ÀŒ√»◊Õ”ﬁ COMPUTE STEP ÀŒ√» ”  ŒÕ—“¿Õ“!
	void WaitComputePrepass(SDL_GPUDevice* dev);
	// Õ‡˜ËÌ‡ÂÚ Ë Á‡‚Â¯‡ÂÚ SDL_GPUComputePass
